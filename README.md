...
**From here the replay runs at wire speed: blast drops the pacing, and one NIC port carries
the A feed and the B feed together at 8 to 8.3 Gb/s. Live trading gives each feed its own
link.**

![v10 to v11](charts/v10_v11.svg)

What v11 did:

1) I used ILP and MLP again, this time after diagnosing the code.
2) It only makes the tail better, and p50 comes out slightly worse. p50 is 5.5 to 6 μs
   here because the replay runs at the full speed of the wire, without a break.

| round | p50 | p99 | p99.9 | p99.99 | max | >10 μs | >20 μs | >30 μs | >40 μs | >60 μs |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| A1 | 5,587 | 13,627 | 24,424 | 34,255 | 69,573 | 2,500 | 144 | 14 | 1 | 1 |
| A2 | 5,796 | 13,511 | 23,490 | 42,114 | 81,487 | 2,484 | 106 | 20 | 7 | 2 |
| A3 | 5,737 | 13,921 | 24,492 | 48,132 | 57,787 | 2,575 | 146 | 14 | 8 | 0 |
| A4 | 5,678 | 13,059 | 22,443 | 45,203 | 82,113 | 2,233 | 85 | 24 | 9 | 1 |
| A5 | 5,736 | 14,022 | 29,282 | 68,164 | 88,208 | 2,530 | 163 | 56 | 28 | 7 |
| **A, mean of 5** | **5,707** | **13,628** | **24,826** | **47,574** | **75,834** | **2,464** | **128.8** | **25.6** | **10.6** | **2.2** |
| B1 | 5,648 | 13,114 | 22,572 | 30,939 | 39,905 | 2,290 | 89 | 7 | 0 | 0 |
| B2 | 5,647 | 13,510 | 21,720 | 31,742 | 40,412 | 2,422 | 89 | 7 | 2 | 0 |
| B3 | 5,826 | 13,389 | 21,706 | 28,081 | 56,110 | 2,396 | 91 | 5 | 1 | 0 |
| B4 | 5,916 | 15,342 | 24,973 | 33,117 | 44,316 | 2,825 | 203 | 11 | 3 | 0 |
| B5 | 5,856 | 13,811 | 23,215 | 28,460 | 38,468 | 2,481 | 119 | 3 | 0 | 0 |
| **B, mean of 5** | **5,779** | **13,833** | **22,837** | **30,468** | **43,842** | **2,483** | **118.2** | **6.6** | **1.2** | **0.0** |
| **B against A** | **+1.3%** | **+1.5%** | **-8.0%** | **-36.0%** | **-42.2%** | **+0.7%** | **-8.2%** | **-74.2%** | **-88.7%** | **-100%** |

`>10 μs` is the number of orders that took longer than 10 μs.

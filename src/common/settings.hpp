...
inline constexpr std::size_t kRxSlotBytes = 512;
...
inline constexpr std::size_t kEthMtu = 484;
...
static_assert(kMaxPacketPayload == 436);
static_assert(kMaxFrameBytes == 498);
